...
def main(opts):
    ...
    #main paras
    opts.epochs = 40
    opts.train_batch_size = 32 # if there are 4 devices in ddp, bs=128 in total
    ...
    save_root = 'Public_Dataset/Cloud_multimodal/checkpoint/TuneUni/lr{}_adam_{}layer'.format(opts.learning_rate, opts.layer_num)
    ...
    #load from step1
    resume_path = 'Public_Dataset/Cloud_multimodal/checkpoint/step1/lr3e-05_adam_3layer/39_train.pth'
    load_pth(model, resume_path)
    model.cuda()
